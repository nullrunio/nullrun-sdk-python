...
The v0.x `openai.ChatCompletion.create` patcher was removed in
0.4.0 — openai >= 1.0 does not expose that attribute. All OpenAI
v1.0+ traffic is tracked vendor-independently by the httpx
