...
Removed zombie exception classes (CostLimitExceeded, ApprovalRequired,
BreakerTimeout) are not re-exported because they had zero in-tree
callers. See the NOTE block in ``nullrun.breaker.exceptions`` for
the full list.
"""
